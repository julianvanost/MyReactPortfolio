          ...
          <div className="row">
            ...
            <div className="col-md-9">
              <p className="">
                ...
                </svg><a className="largerLinks" target="_blank" href="https://github.com/julianvanost">My Github Page</a>
              </p>
              <p>
                ...
                <a className="largerLinks" target="_blank" href="https://www.linkedin.com/in/julian-b-van-ost-ab3a5262">My
                Linkedin Page</a>
              </p>
              <p>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <a className="largerLinks" target="_blank" href="https://www.returntoworksolutions.com/julian-van-ost">My Web
                Portfolio</a>
              </p>
              <p className="text-center">
                <img className="logoCryp" src="./ci-logo.png" alt="CrypIt Logo"></img>
                <p>
                  <a className="text center largerLinks" target="_blank" href="https://preyx.github.io/bcprj1-api/">
